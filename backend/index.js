...
const corsOptions = {
  ...
  origin: "https://vercel.com/saiteja-adapas-projects/marriage-management-admin-se/8Wf28u26dwtCArYfiAx7wKdaCrRZ",
...
app.post("/createdesigner", async (req, res) => {
  const { image, fname, lname, phone, email, dob, ad1, ad2, city, pincode } =
    req.body;
  const q =
